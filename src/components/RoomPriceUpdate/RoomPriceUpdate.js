...
export default function RoomPriceUpdate() {
  ...
  function handleInputChange(e) {
    ...
    if (
      e.target.name === "non_ac_single" ||
      e.target.name === "non_ac_double" ||
      e.target.name === "ac_singleCurrent Room " ||
      e.target.name === "ac_double"
    ) {
      setState({
        ...state,
        data: {
        ...
        <>
          <Paper sx={{ maxWidth: 936, margin: "auto", overflow: "hidden" }}>
            ...
            >
              ...
              <h2 style={{ marginBottom: "10px" }}>Current Room Rates</h2>
              <Grid container spacing="0">
                <Grid item lg={12} className="border-right border-bottom">
                  <div>
                    <div className="main-div">
                      <p>NON AC Single Room</p>
                    </div>
                  </div>
                  <div>
                    <div className="main-div">
                      <p>
                        {state.data.roomCharges &&
                          state.data.roomCharges.map((room) => {
