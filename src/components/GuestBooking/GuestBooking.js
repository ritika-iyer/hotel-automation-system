    ...
    <>
      {
        ...
        state.error
          ? window.alert(
              "Unfortunately, No rooms are available of your choice. Please select another category of room."
            )
          : null
      }
      {bookRoom ? (
              ...
              <Grid container spacing="3">
                ...
                <Grid item lg={12}>
                  ...
                  <input
                    ...
                    name="advance_paid"
                    onChange={handleInputChange}
                    placeholder="Advance Amount Paid (If any)"
                    mandatory
                  />
                </Grid>
                <Grid item lg={12}>
        ...
        <>
          <Typography sx={{ my: 3, mx: 2 }} color="#00997a" align="center">
            {" "}
            <h1> Hotel IIIT </h1>
            <h3>Bookings</h3>
          </Typography>
            ...
            >
              {state.data.guest_list && state.data.guest_list.length > 0 ? (
                <TableContainer component={Paper}>
                  <Table
                    sx={{ minWidth: 650, bgcolor: "#ccffdd" }}
                    aria-label="simple table"
                  >
                    <TableHead sx={{ bgcolor: "#00997a" }}>
                      <TableRow>
                        <TableCell
                          style={{
                            fontWeight: "bold",
                    ...
                    <TableBody>
                      {state.data.guest_list &&
                        state.data.guest_list.map((guest) => {
                          return (
                            <TableRow
