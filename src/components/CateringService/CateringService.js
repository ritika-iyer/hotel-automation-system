...
export default function CateringService() {
  ...
  function handleInputChange(e) {
    ...
    if (
      ...
      e.target.name === "lunch" ||
      e.target.name === "dinner" ||
      e.target.name === "snacks"
    ) {
      setState({
        ...state,
        data: {
  ...
  function handleSubmit() {
    fetch("http://127.0.0.1:8000/api/cateringorders/", {
      ...
      body: JSON.stringify({
        breakfast_quantity: state.data.breakfast
          ? state.data.breakfast_quantity
          : 0,
  ...
  return (
    <>
      {orderFood ? (
              ...
              <Grid container spacing="3">
                <Grid item lg={6}>
                  ...
                  >
                    ...
                    {state.data.guest_list &&
                      state.data.guest_list.map((guest, index) => {
                        return (
                ...
                <Grid item lg={6}>
                  ...
                  >
                    ...
                    >
                      <span>
                        <label className={classes.InputLabel}>Breakfast</label>
                      </span>
                    </div>
                  </div>
                  <div
                  ...
                  >
                    ...
                    >
                      <span>
                        <label className={classes.InputLabel}>Lunch</label>
                      </span>
                    </div>
                  </div>
                  <div
                  ...
                  >
                    ...
                    >
                      <span>
                        <label className={classes.InputLabel}>Dinner</label>
                      </span>
                    </div>
                  </div>
                  <div
                  ...
                  >
                    ...
                    >
                      <span>
                        <label className={classes.InputLabel}>Snacks</label>
                      </span>
                    </div>
                  </div>
                </Grid>
                <Grid item lg={12}>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    mandatory
                    disabled={!state.data.breakfast ? true : false}
                  />
                </Grid>
                <Grid item lg={12}>
                  <div className="d-flex align-center space-between">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    mandatory
                    disabled={!state.data.lunch ? true : false}
                  />
                </Grid>
                <Grid item lg={12}>
                  <div className="d-flex align-center space-between">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    mandatory
                    disabled={!state.data.dinner ? true : false}
                  />
                </Grid>
                <Grid item lg={12}>
                  <div className="d-flex align-center space-between">
                  ...
                  <input
                    type="number"
                    min="0"
                    name="snacks_quantity"
                    onChange={handleInputChange}
                    mandatory
                    disabled={!state.data.snacks ? true : false}
                  />
                </Grid>
                <Grid item lg={12}>
        ...
        <>
          <Typography sx={{ my: 5, mx: 2 }} color="#00997a" align="center">
            {" "}
              ...
              {state.data.order_list && state.data.order_list.length > 0 ? (
                <TableContainer component={Paper}>
                  <Table sx={{ minWidth: 650 }} aria-label="simple table">
                    ...
                    <TableBody>
                      {state.data.order_list &&
                        state.data.order_list.map((order) => {
                          return (
                            <TableRow
                              key={order.guest}
                              sx={{
                            ...
                            >
                              ...
                              <TableCell align="right">
                                {order.breakfast_quantity}
                              </TableCell>
                              <TableCell align="right">
                                {order.lunch_quantity}
                              </TableCell>
                              <TableCell align="right">
                                {order.dinner_quantity}
                              </TableCell>
                              <TableCell align="right">
                                {order.snacks_quantity}
                              </TableCell>
                            </TableRow>
                          );
                        })}
